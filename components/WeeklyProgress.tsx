...
const styles = StyleSheet.create({
  ...
  goal: { fontFamily: 'Inter_400Regular', fontSize: 13 },
  hoursRow: { flexDirection: 'row', alignItems: 'baseline', marginBottom: Spacing.sm },
  currentHours: { fontFamily: 'Inter_700Bold', fontSize: 28, lineHeight: 34 },
  targetLabel: { fontFamily: 'Inter_400Regular', fontSize: 16 },
  progressTrack: { height: 10, borderRadius: Radius.full, overflow: 'hidden', marginBottom: Spacing.sm },
  progressFill: { height: '100%', borderRadius: Radius.full },
  daysRow: { flexDirection: 'row', justifyContent: 'space-between' },
  dayLabel: { fontFamily: 'Inter_400Regular', fontSize: 13, flex: 1, textAlign: 'center' },
  dayLabelActive: { fontFamily: 'Inter_700Bold' },
});
